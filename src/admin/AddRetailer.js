...
const Retailer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Add a new document to the "retailers" collection in Firestore
      ...
      setMessage('Failed to add retailer. Please try again.');
      setIsSuccess(false);
    } finally {
      setIsLoading(false);
    }
  ...
  const fields = [
    ...
    { label: "Retailer's Name", name: "retailerName", type: "text" },
    { label: "Aadhaar No.", name: "adhaarNo", type: "text" },
    { label: "Retailer's Address", name: "retailerAddress", type: "text" },
  ...
  return (
    <div style={containerStyle}>
      <div style={cardStyle}>
        <h1 style={headingStyle}>Add New Retailer</h1>
        <form onSubmit={handleSubmit}>
          ...
          <div style={buttonContainerStyle}>
            <button 
              ...
              disabled={isLoading}
            >
              {isLoading ? 'Adding Retailer...' : 'Add Retailer'}
            </button>
          </div>
        </form>
